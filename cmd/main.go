...
import (
	...
	"github.com/Kraftnetes/k8s-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(kraftnetescomv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5168bb37.kraftnetes.com",
